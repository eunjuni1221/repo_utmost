...
;(function($){
	...
	var Core = {
		...
		ChartJs: function() {
			...
			// 타율 history (팀) 수정했습니다 원래 골이였는데 타자 기록으로 교체했습니다
			if ( chart_goals_history_hockey.exists() ) {
				var dataGoalsHockey = {
					...
					data: {
						...
						datasets: [{
							label: '삼성',
							data: [0.312, 0.289, 0.244, 0.301],
							backgroundColor: "#6c4dee",
						}, {
							label: '리그 평균 타율',
							data: [0.291, 0.264, 0.238, 0.297],
			...
			// 	var chart_goals_history_hockey = $('#js-alc-goals-history-hockey');
			// 	var ctx = chart_goals_history_hockey[0].getContext('2d');
			
			// 	var chartData = {
			// 		"타율": [0.312, 0.289, 0.244, 0.301],
			// 		"출루율": [0.380, 0.345, 0.320, 0.390],
			// 		"장타율": [0.510, 0.470, 0.430, 0.520],
			// 		"OPS": [0.890, 0.815, 0.750, 0.910]
			// 	};
			
			// 	var leagueData = {
			// 		"타율": [0.291, 0.264, 0.238, 0.297],
			// 		"출루율": [0.360, 0.330, 0.310, 0.370],
			// 		"장타율": [0.480, 0.450, 0.420, 0.500],
			// 		"OPS": [0.840, 0.790, 0.730, 0.870]
			// 	};
			...
			// 			datasets: [{
			// 				label: '삼성',
			// 				data: chartData["타율"], // 기본값
			// 				backgroundColor: "#6c4dee",
			// 			}, {
			// 				label: '리그 평균',
			// 				data: leagueData["타율"], // 기본값
			// 				backgroundColor: "#00e6e3"
			// 			}]
			// 		},
			// 		options: {
			...
			// 					ticks: { fontColor: '#37353c', fontFamily: 'Ubuntu, sans-serif', fontSize: 10 }
			// 				}]
			// 			}
			// 		}
			// 	};
			...
			// 		myChart.data.datasets[0].data = chartData[selectedStat];
			// 		myChart.data.datasets[1].data = leagueData[selectedStat];
